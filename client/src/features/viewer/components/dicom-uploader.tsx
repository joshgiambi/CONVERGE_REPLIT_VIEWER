...
export function DICOMUploader() {
  ...
  useEffect(() => {
    ...
    // Poll for triage sessions only while not actively uploading (to catch background completions)
    // Reduced frequency to avoid excessive re-renders
  ...
  }, [isUploading]); // Depend on isUploading to control polling
